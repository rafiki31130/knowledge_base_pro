...
[Parsing phase : ce qui s'exécute où](splunk-parsing-phase-uf-vs-hf.md) (ne pas le
recopier ici).
...
[Parsing phase : ce qui s'exécute où](splunk-parsing-phase-uf-vs-hf.md).
...
- [Parsing phase : ce qui s'exécute où](splunk-parsing-phase-uf-vs-hf.md) — détail UF vs HF/indexer
- [`_time` vs `_indextime`](time-vs-indextime.md) — les deux horodatages à ne pas confondre
- [Cycle de vie des buckets en multisite](splunk-buckets-multisite-lifecycle.md) — ce que devient la donnée après l'index phase
