...
- [Déclencheurs de rolling restart : SHC & cluster d'indexers](r_knowledge_base_pro/concepts/splunk/rolling-restart-triggers.md) — [EN](r_knowledge_base_pro/concepts/EN/rolling-restart-triggers.md)
- [`splunk.secret` en SHC : propagation à l'ajout de membre](r_knowledge_base_pro/concepts/splunk/shc-splunk-secret-propagation.md) — [EN](r_knowledge_base_pro/concepts/EN/shc-splunk-secret-propagation.md)
