...
| `splunk-exploitation-handbook/` | Livré (2026-08-03) | Responsable d'exploitation / architecte / admin senior Splunk, Splunk Enterprise 9.x on-prem, plateforme mutualisée | 5 chapitres + cheatsheet : organiser le RUN Splunk en **séparant l'exploitation de l'infrastructure** (socle) de **l'exploitation des données & de l'expérience utilisateur** — modèle à deux plans, catalogue d'activités, **RACI d'exploitation** (six rôles PLT/DAT/SEC/HEB/PO/USR), registre de risques et contraintes opérationnelles, interfaces/contrats/rituels + cheatsheet. Français. |
